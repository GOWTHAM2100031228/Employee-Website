var form = document.getElementById("myForm"),
    ...
    userName = document.getElementById("lname"),
...
function readInfo(pic, name, lname, age, city, email, phone, post, sDate){
    document.querySelector('.showImg').src = pic,
    document.querySelector('#showName').value = name,
    document.querySelector('#showName').value = lname,
...
function editInfo(index, pic, name, lname, Age, City, Email, Phone, Post, Sdate){
    isEdit = true
    editId = index
    imgInput.src = pic
    userName.value = name
